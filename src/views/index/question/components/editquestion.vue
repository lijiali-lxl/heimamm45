  ...
  >
    ...
    >
      ...
      <el-form-item label="阶段" prop="step" :label-width="formLabelWidth">
        <el-select v-model="editquestionForm.step" placeholder="请选择角色">
      ...
      <el-form-item label="企业" prop="enterprise" :label-width="formLabelWidth">
        <el-select v-model="editquestionForm.enterprise" placeholder="请选择角色">
          <el-option
      ...
      <el-form-item label="城市" prop="city" :label-width="formLabelWidth">
        <el-cascader v-model="editquestionForm.city" :options="options" @change="handleChange"></el-cascader>
      </el-form-item>
      ...
      >
        ...
        <el-radio-group v-model="editquestionForm.single_select_answer">
          ...
          <div class="danxuan">
            ...
            <el-input v-model="editquestionForm.select_options[0].text" placeholder="请输入内容"></el-input>
            <el-upload
          ...
          <div class="danxuan">
            ...
            <el-input v-model="editquestionForm.select_options[1].text" placeholder="请输入内容"></el-input>
            <el-upload
              class="avatar-uploader"
              :action="uploadURL"
              :show-file-list="false"
          ...
          <div class="danxuan">
            ...
            <el-input v-model="editquestionForm.select_options[2].text" placeholder="请输入内容"></el-input>
            <el-upload
              class="avatar-uploader"
              :action="uploadURL"
              :show-file-list="false"
          ...
          <div class="danxuan">
            ...
            <el-input v-model="editquestionForm.select_options[3].text" placeholder="请输入内容"></el-input>
            <el-upload
              class="avatar-uploader"
              :action="uploadURL"
              :show-file-list="false"
      ...
      <el-form-item
        ...
        prop="short_answer"
        :label-width="formLabelWidth"
        v-else-if="editquestionForm.type==3"
      >
        <el-input
          type="textarea"
          :rows="2"
      ...
      <el-form-item label="视频解析" :label-width="formLabelWidth">
        ...
        <video :src="videoURL" controls autoplay loop class="video" ></video>
      </el-form-item>
      ...
      <el-form-item label="用户备注" :label-width="formLabelWidth" prop="remark">
        <el-input v-model="editquestionForm.remark" autocomplete="off"></el-input>
      </el-form-item>
    </el-form>
    ...
    opened() {
      if (this.topeditor == undefined) {
        ...
        this.topeditor.customConfig.onchange = html => {
          // html 即变化之后的内容
          this.editquestionForm.title = html;
        };
      ...
      if (this.ansuer == undefined) {
        ...
        this.ansuer.customConfig.onchange = html => {
          // html 即变化之后的内容
          this.editquestionForm.answer_analyze = html;
        };

        this.ansuer.create();
      }
          // 因为是编辑 需要 设置内容
      this.topeditor.txt.html(this.editquestionForm.title);
      this.ansuer.txt.html(this.editquestionForm.answer_analyze);
    },
    handleChange(value) {
